...
import argparse
import getpass
from lab.stage1.scrapers.twitter.selenium_scrapper.scraper.twitter_scraper import Twitter_Scraper
    ...
    try:
        ...
        try:
            parser.add_argument(
                "--mail",
                type=str,
                default=os.getenv("TWITTER_MAIL") or os.getenv("TWITTER_EMAIL"),
