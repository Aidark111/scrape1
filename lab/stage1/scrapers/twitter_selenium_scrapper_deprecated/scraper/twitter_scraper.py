...
import sys
import pandas as pd
from lab.stage1.scrapers.twitter.selenium_scrapper.scraper.progress import Progress
from lab.stage1.scrapers.twitter.selenium_scrapper.scraper.scroller import Scroller
from lab.stage1.scrapers.twitter.selenium_scrapper.scraper.tweet import Tweet
...
class Twitter_Scraper:
    ...
    def _get_driver(
        ...
        chrome_option.add_argument(f"--user-agent={header}")
        ...
        try:
            ...
            try:
                ...
                firefox_option.add_argument(f"--user-agent={header}")
                if self.headlessState == 'yes':
    ...
    def _input_unusual_activity(self):
        ...
        while True:
            try:
                ...
                # Twitter/X may request username, email, or phone for verification.
                unusual_activity.send_keys(self.mail if self.mail else self.username)
